                    ...
                    <Card>
                        <Row>
                            ...
                            <Col style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column', marginLeft: 10 }}>
                                <h4 style={{ fontSize: 20 }}>UzumakiHan</h4>
                        ...
                        <Row style={{ marginTop: 20 }}>
                            <Col>
                                ...
                                <Paragraph>
                                    ...
                                    比较喜欢积累以及整理前端开发的代码素材。学过了技术栈有Vue、Node、Mysql，React、Uni-app、Taro、Mongodb,能够熟练的编写项目，
                                    不过还是需要不断地学习巩固，现在工作上的主要运用的是Vue来实现代码业务功能。
                                </Paragraph>
